(function () {
	...
	mare.views.FamilyListingReport = Backbone.View.extend({
		...
		familyListingColumns: [
			...
			{ title: 'Relationship Status', data: 'relationshipStatus', defaultContent: '--' },
			...
			{ title: 'Contact 1 Identifies as LGBTQ+?', data: 'contact1.identifiesAsLGBTQ', defaultContent: '--' },
			{ title: 'Contact 2 Identifies as LGBTQ+?', data: 'contact2.identifiesAsLGBTQ', defaultContent: '--' },
