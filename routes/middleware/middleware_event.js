...
exports.register = ( req, res, next ) => {
	...
	let register	= eventService.register( eventId, eventDetails, req.user ),
		notifyStaff	= eventEmailMiddleware.sendEventRegistrationEmailToStaff( eventDetails, 'jared.j.collier@gmail.com' ); // TODO: need to fetch the staff contact to send the email to
