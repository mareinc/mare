...
InternalNotes.add( 'Target', {
    ...
    date: { type: Types.Date, label: 'note date', inputFormat: 'MM/DD/YYYY', format: 'MM/DD/YYYY', default: Date.now(), utc: true, initial: true, note: 'if no date is specified today\'s date will be used' },
