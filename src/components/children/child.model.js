...
Child.add( 'Display Options', {
	...
	visibleInGalleryDate: { type: Types.Date, label: 'date communications team published/re-published to Child Gallery', note: 'date communications team published/re-published to Child Gallery', inputFormat: 'MM/DD/YYYY', format: 'MM/DD/YYYY', default: '', utc: true, dependsOn: { isVisibleInGallery: true }, initial: true, collapse: true }
