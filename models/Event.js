...
Event.add( 'General Information', {
	...
	startTime: { type: Types.Text, label: 'start time', utc: true, dependsOn: { recurringEvent: false }, initial: true },
	...
	endTime: { type: Types.Text, label: 'end time', initial: true, utc: true, dependsOn: { recurringEvent: false } },
