...
Child.add({
	...
	contactWithSiblings: { type: Types.Boolean, label: 'Has contact with siblings?', index: true, initial: true },
	siblingContacts: { type: Types.Text, label: 'Siblings (comma separated)', initial: true }, // TODO: We should link to siblings with a Relationship field if they're in the system
	contactWithBirthFamily: { type: Types.Boolean, label: 'Has contact with birth family?', initial: true },
	birthFamilyContacts: { type: Types.Text, label: 'Birth Family (comma separated)', initial: true },
	profile: {
